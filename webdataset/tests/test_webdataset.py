# Use Dataset instead of WebDataset
...
# remote_shard = "openimages-train-000000.tar"
...
#     ds = wds.WebDataset(remote_loc + remote_shards, decoder=None)
